...
import adapter.ContactUsAdapter;
import adapter.HelpAdapter;
import models.ContactUsItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnContactUs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btnContactUs.setTextColor(ContextCompat.getColor(HelpCenterActivity.this, R.color.primary));
        ...
        btnFAQ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                btnFAQ.setTextColor(ContextCompat.getColor(HelpCenterActivity.this, R.color.primary));
